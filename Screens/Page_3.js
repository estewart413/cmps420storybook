  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        >
          <ImageBackground
            source={require("../Assets/Page_3StockPic.jpg")}
            //resizeMode="contain"
        ...
        <View style={{ flexDirection: "row", marginBottom: 55 }}>
          <TouchableOpacity
            onPress={() => this.props.navigation.navigate("Page_2")}
          >
            <Image
        ...
        <View style={{ padding: 15, flexDirection: "row-reverse" }}>
          ...
          <Text style={styles.text}>
            Once upon a time, there was a page THREE of a story. This story was very interesting and lots of fun.
          </Text>
          </View>
